...
def male_generation():
    ...
    url = []
    title_list = []
    sites = ['https://www.letemps.ch/', 'https://www.20min.ch/fr','https://agefi.com/','https://lecourrier.ch/','https://www.lematin.ch/',
            'https://www.illustre.ch/', 'https://www.pme.ch/', 'https://www.bilan.ch/', 'https://www.market.ch/fr/accueil.html', 'https://www.rts.ch/info/',
            'https://www.seco.admin.ch/seco/de/home.html', 'https://www.rhonefm.ch/', 'https://canal9.ch/fr/']
    # flag=int(input('1:stocks  2:funds  3:crypto'))
    for site in sites:
      query = 'Comptes and Hypothèques Crédits'+' '+site
      mkt = ['fr']
