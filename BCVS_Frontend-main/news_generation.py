...
def news_generation(query):
    ...
    sites = ['https://www.letemps.ch/', 'https://www.lenouvelliste.ch/', 'https://www.rts.ch/info/',
             'https://www.suisse-romande.com/journaux-magazines-suisse-romande.html','https://www.20min.ch/fr ','https://agefi.com/',
            'https://lecourrier.ch/','https://www.lematin.ch/','https://www.illustre.ch/','https://www.pme.ch/','https://www.bilan.ch/',
            'https://www.market.ch/fr/accueil.html','https://www.seco.admin.ch/seco/de/home.html',
            'https://www.rhonefm.ch/','https://canal9.ch/fr/']
